...
class SeedSettingsData extends Migration
{
    ...
    public function up()
    {
        ...
        // 联系方式
        Setting::create(['owner' => 'system', 'module' => 'common', 'section' => 'contact', 'key' => 'contacts', 'value' => 'Cmspackage']);
        ...
        Setting::create(['owner' => 'system', 'module' => 'common', 'section' => 'contact', 'key' => 'email', 'value' => 'qqiu@qq.com']);
